...
pluralCaseList.push( {plural: "serviceApplications/serviceApplications", pascal: "ServiceApplicationServiceApplication"} )
pluralCaseList.push( {plural: "serviceApplications/formTemplates", pascal: "ServiceApplicationFormTemplate"} )

pluralCaseList.push( {plural: "eligibilityVerifications/eligibilityChecks", pascal: "EligibilityVerificationEligibilityCheck"} )

pluralCaseList.push( {plural: "dataCollections/externalData", pascal: "DataCollectionExternalData"} )

pluralCaseList.push( {plural: "applicationDocuments/applicationDocuments", pascal: "ApplicationDocumentApplicationDocument"} )

pluralCaseList.push( {plural: "documentIssuances/issuedDocuments", pascal: "DocumentIssuanceIssuedDocument"} )
