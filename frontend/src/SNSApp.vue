            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        ...
                        to="/serviceApplications/serviceApplications"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="formTemplates"
                        to="/serviceApplications/formTemplates"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="eligibilityChecks"
                        to="/eligibilityVerifications/eligibilityChecks"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="externalData"
                        to="/dataCollections/externalData"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/applicationDocuments/applicationDocuments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="issuedDocuments"
                        to="/documentIssuances/issuedDocuments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                key: 'serviceApplications', 
                route: '/serviceApplications/serviceApplications',
                ImageUrl: '',
            },
            { 
                title: '서식 조회', 
                description: 'FormTemplate을 관리하는 화면입니다.', 
                key: 'formTemplates', 
                route: '/serviceApplications/formTemplates',
                ImageUrl: '',
            },
            { 
                title: '자격 조회', 
                description: 'EligibilityCheck을 관리하는 화면입니다.', 
                key: 'eligibilityChecks', 
                route: '/eligibilityVerifications/eligibilityChecks',
                ImageUrl: '',
            },
            { 
                title: '추가 데이터 조회', 
                description: 'ExternalData을 관리하는 화면입니다.', 
                key: 'externalData', 
                route: '/dataCollections/externalData',
                ImageUrl: '',
            },
            { 
                title: '신청서 작성', 
                description: 'ApplicationDocument을 관리하는 화면입니다.', 
                key: 'applicationDocuments', 
                route: '/applicationDocuments/applicationDocuments',
                ImageUrl: '',
            },
            { 
                title: '발급문서 처리', 
                description: 'IssuedDocument을 관리하는 화면입니다.', 
                key: 'issuedDocuments', 
                route: '/documentIssuances/issuedDocuments',
                ImageUrl: '',
            },
