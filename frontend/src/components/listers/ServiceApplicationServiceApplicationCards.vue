    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <ServiceApplicationServiceApplication :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row class="ma-0 pa-0">
            <v-col class="pa-4" cols="12" sm="6" md="3" v-for="(value, index) in values" :key="index">
                <ServiceApplicationServiceApplication :offline="offline"
...
<script>
    ...
    import ServiceApplicationServiceApplication from './../ServiceApplicationServiceApplication.vue';

    export default {
        name: 'ServiceApplicationServiceApplicationManager',
        components: {
            ServiceApplicationServiceApplication,
        },
        props: {
            offline: Boolean
        },
